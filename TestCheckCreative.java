...
public class Test2 {
  ...
  //@Test
  public void testCheckCreative() throws Exception {
	    driver.get(baseUrl + "/");
	    ...
	    driver.findElement(By.linkText("Selenium Test1")).click();
	    assertEquals("Selenium Test1", driver.findElement(By.id("id_creative-name")).getText());
	    assertEquals("Selenium Test2", driver.findElement(By.id("id_creative-advertiser_name")).getText());
	    //assertEquals("Selenium Test3", driver.findElement(By.id("id_article-title")).getText());
	    //assertEquals("Selenium Test4", driver.findElement(By.id("id_article-description")).getText());
	    //assertEquals("Selenium Test5", driver.findElement(By.id("id_name")).getText());
  }
